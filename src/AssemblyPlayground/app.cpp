...
// Register names
const char* reg_names[] = { "EAX", "EBX", "ECX", "EDX", "ESP", "EBP", "ESI", "EDI", "EIP" };
...
//    io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable;
    ...
    emulator_state->update_disassembler_fn = [](cs_insn* instructions, size_t count){
    ...
    disassembler.step_fn = [](){
        emulator_state->step();
    };
    disassembler.reset_fn = [](){
...
void Application::Render() {
    ...
    ImGui::InputTextMultiline("##asm_editor", assembly_code, sizeof(assembly_code), ImVec2(-FLT_MIN, ImGui::GetTextLineHeight() * 20));
    ...
    ImGui::BeginTable("Registers", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg);
